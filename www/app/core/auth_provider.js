(function() {
  ...
  function authProvider($q, $http, quizServer, localStorageService) {
    var _loggedIn = false,
      _loaded = $q.defer(),
      _me = null;
    ...
    function register(username, password) {
      ...
      logout();
      return quizServer.post('/register', params)
    ...
    function saveTokenToStore(token) {
      token = token || null;
